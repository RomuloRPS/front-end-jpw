...
export default class Pessoas extends React.Component{
    ...
    render(){
        return  <div>
        <NavBar></NavBar><div className="container" style={{width: '50%'}}>
            ...
            <div className="row" style={{"margin-top" : "30px"}}>
                ...
                <div className="col-md-12">
                    ...
                    <button style={{"margin-top" : "10px", marginBottom: '10px'}}  type="button" className="btn btn-primary" onClick={this.getAllPessoas}>Atualizar</button>
                    <section>
                        <ListaPessoa
